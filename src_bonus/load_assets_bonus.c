...
int	load_assets_player(t_game *game, int w, int h)
{
	char	*paths[4];
	int		i;
...
int	load_assets_collectible(t_game *game, int w, int h)
{
	char	*paths[4];
	int		i;
...
int	load_assets_exit(t_game *game, int w, int h)
{
	char	*paths_open[4];
	char	*paths_close[4];
	int		i;
...
int	load_assets_enemy(t_game *game, int w, int h)
{
	char	*path_enemy_up;
...
int	load_assets(t_game *game, int w, int h)
{
	...
	if (!game->img_floor)
		return (0);
	if (!load_assets_player(game, w, h))
		return (0);
	if (!load_assets_collectible(game, w, h))
		return (0);
	if (!load_assets_exit(game, w, h))
		return (0);
	if (!load_assets_enemy(game, w, h))
		return (0);
	return (1);
}
